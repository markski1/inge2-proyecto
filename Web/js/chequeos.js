...
function validarRegistro() {
	...
	var cc_venc_dia = document.getElementById("cc_venc_dia");
	...
	if (isNaN(cc_venc_dia.value) || isNaN(cc_venc_mes.value) || isNaN(cc_venc_anno.value) || isNaN(nac_dia.value) || isNaN(nac_mes.value) || isNaN(nac_anno.value) || isNaN(cc_seg.value) || isNaN(cc_num.value)) {
